...
public class PrivateCompany {
	...
	@Column(name = "fpc_hq_addr_street_1")
	private String street1;
	
	@Column(name = "fpc_hq_addr_street_2")
	private String street2;
	
	@Column(name = "fpc_hq_addr_street_3")
	private String street3;
	
	@Column(name = "fpc_hq_addr_street_4")
	private String street4;
	
	@Column(name = "fpc_hq_addr_street_5")
	private String street5;
	
	@Column(name = "fpc_hq_addr_city")
	private String city;
	
	@Column(name = "fpc_hq_addr_state_name")
	private String state;
	
	@Column(name = "fpc_hq_addr_postal_code")
	private String postalCode;
	
	@Column(name = "fpc_hq_addr_country_name")
	private String countryName;
	
	@Column(name = "tot_emp")
	private String totalEmp;
	
	@Column(name = "crunchbase_rank")
	...
	public String toString() {
		return "PrivateCompany [id=" + id + ", name=" + name + ", industryCode=" + industryCode + ", industryName="
