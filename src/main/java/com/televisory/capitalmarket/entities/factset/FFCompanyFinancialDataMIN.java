...
public class FFCompanyFinancialDataMIN {
	...
	@Column(name = "latest_ann_update", insertable = false)
	@Temporal(TemporalType.DATE)
	...
	public String toString() {
		return "FFCompanyFinancialDataMIN [id=" + id + ", companyId=" + companyId + ", financialType=" + financialType
				...
				+ displayName + ", period=" + period + ", applicablePeriod=" + applicablePeriod + ", latestAnnualDate="
				+ latestAnnualDate + ", currency=" + currency + ", data=" + data + ", keyParameter=" + keyParameter
				+ ", keyParameterOrder=" + keyParameterOrder + ", icFlag=" + icFlag + ", screenerFlag=" + screenerFlag
