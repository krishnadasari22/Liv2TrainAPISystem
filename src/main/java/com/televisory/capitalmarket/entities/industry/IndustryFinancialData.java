...
public class IndustryFinancialData {
	...
	public String toString() {
		return "IndustryFinancialData [id=" + id + ", displayOrder=" + displayOrder + ", depthLevel=" + depthLevel
				+ ", displayFlag=" + displayFlag + ", fieldName=" + fieldName + ", shortName=" + shortName
				+ ", itemName=" + itemName + ", ticsIndustry=" + ticsIndustry + ", company=" + company + ", periodType="
				+ periodType + ", companyCount=" + companyCount + ", domicileCountry=" + domicileCountry + ", period="
				+ period + ", applicablePeriod=" + applicablePeriod + ", unit=" + unit + ", data=" + data
				+ ", currency=" + currency + "]";
	}		
