...
public class CompanyFinancialMINDTO implements Serializable{

	/**
	 * 
	 */
	private static final long serialVersionUID = -1054494249325650014L;
	...
	public Date getLatestAnnualDate() {
		return latestAnnualDate;
	}

	public void setLatestAnnualDate(Date latestAnnualDate) {
		this.latestAnnualDate = latestAnnualDate;
	}

	@Override
	public String toString() {
		return "CompanyFinancialMINDTO [id=" + id + ", periodType=" + periodType + ", period=" + period
				+ ", applicablePeriod=" + applicablePeriod + ", latestAnnualDate=" + latestAnnualDate + ", depthLevel="
				...
				+ ", currency=" + currency + ", companyId=" + companyId + ", isActive=" + isActive + ", createdAt="
				+ createdAt + ", creadtedBy=" + creadtedBy + ", lastmodifiedAt=" + lastmodifiedAt + ", lastModifiedBy="
				+ lastModifiedBy + ", keyParameter=" + keyParameter + ", keyParameterOrder=" + keyParameterOrder
