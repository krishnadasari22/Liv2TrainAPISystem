...
import com.televisory.capitalmarket.util.ExcelStyleUtil;
...
public class ExcelStyle {
	...
	public ExcelStyle(XSSFWorkbook workbook) {
		...
		Map<String, CellStyle> mapStyle =  ExcelStyleUtil.getAllStyles(workbook);
	...
	/*public HSSFColor setColor(byte r, byte g, byte b) {
		Palette palette = workbook.getCustomPalette();
	...
	public void mergeCells(Sheet sheet, int rowFrom, int rowTo, int colFrom, int colTo,boolean border) throws IOException {
