...
public class DerivativeLatestDTO {
	...
	public String toString() {
		return "DerivativeLatestDTO [symbol=" + symbol + ", owncode=" + owncode + ", aii_composite=" + aii_composite
				+ ", esignal_id=" + esignal_id + ", isin=" + isin + ", bb_root=" + bb_root + ", bb_root_market_sector="
				+ bb_root_market_sector + ", bb_ticker=" + bb_ticker + ", bb_price_source=" + bb_price_source
				+ ", bb_market_sector=" + bb_market_sector + ", figi=" + figi + ", figi_comp=" + figi_comp
				+ ", exchange_ticker=" + exchange_ticker + ", osi_21=" + osi_21 + ", asset_type=" + asset_type
				+ ", underlying_name=" + underlying_name + ", contract_description=" + contract_description
				+ ", underlying_type=" + underlying_type + ", underlying_ticker_root=" + underlying_ticker_root
				+ ", underlying_ticker_contract=" + underlying_ticker_contract + ", underlying_isin=" + underlying_isin
				+ ", underlying_sedol=" + underlying_sedol + ", exchange_name=" + exchange_name + ", country_code="
				+ country_code + ", exchange_code=" + exchange_code + ", expiry_date=" + expiry_date + ", maturity="
				+ maturity + ", call_put=" + call_put + ", strike=" + strike + ", option_type=" + option_type
				...
				+ ", open_interest=" + open_interest + ", as_on_date=" + as_on_date + "]";
	}
