...
public class FILatestDataDTO {
	...
	public String toString() {
		return "FILatestDataDTO [as_of_date=" + as_of_date + ", isin_number=" + isin_number + ", description="
				...
				+ years_to_worst + ", iso_currency_code=" + iso_currency_code + ", iso_country_code=" + iso_country_code
				+ ", country_name=" + country_name + ", industry_lvl_1_desc=" + industry_lvl_1_desc
