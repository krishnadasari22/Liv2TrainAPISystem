...
public class CDSDataLatest {
	...
	public String toString() {
		return "CDSDataLatest [cdsDataDetails=" + cdsDataDetails + ", identifier=" + identifier + ", maturity_date="
				+ maturity_date + ", entity_name=" + entity_name + ", ice_cds_code=" + ice_cds_code
				+ ", bbg_cds_ticker=" + bbg_cds_ticker + ", cma_entity_id=" + cma_entity_id + ", cma_ticker="
				+ cma_ticker + ", contract_standard=" + contract_standard + ", sector=" + sector + ", region=" + region
				+ ", coupon=" + coupon + ", market_quoting_convention=" + market_quoting_convention
				+ ", instrument_type=" + instrument_type + ", default_date=" + default_date + ", auction_date="
				+ auction_date + ", par_spread_bid=" + par_spread_bid + ", par_spread_mid=" + par_spread_mid
				+ ", par_spread_offer=" + par_spread_offer + ", quote_spread_bid=" + quote_spread_bid
