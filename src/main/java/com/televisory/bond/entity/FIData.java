...
public class FIData {
	...
	public Integer getBond_equiv() {
		return bond_equiv;
	}

	public void setBond_equiv(Integer bond_equiv) {
	...
	public String toString() {
		return "FIDataLatest [as_of_date=" + as_of_date + ", isin_number="
				+ isin_number + ", description=" + description + ", ticker="
				+ ticker + ", current_period_coupon=" + current_period_coupon
				+ ", maturity_date=" + maturity_date + ", maturity_wal="
				+ maturity_wal + ", years_to_worst=" + years_to_worst
				+ ", iso_currency_code=" + iso_currency_code
				+ ", country_name=" + country_name + ", iso_country_code="
				+ iso_country_code + ", industry_lvl_1_desc="
				+ industry_lvl_1_desc + ", industry_lvl_2_desc="
				+ industry_lvl_2_desc + ", industry_lvl_3_desc="
				+ industry_lvl_3_desc + ", industry_lvl_4_desc="
				+ industry_lvl_4_desc + ", modified_duration_sa="
				+ modified_duration_sa
				+ ", semi_modified_duration_1w_percent_change="
				+ semi_modified_duration_1w_percent_change
				+ ", semi_mod_dur_to_worst=" + semi_mod_dur_to_worst
				+ ", semi_mod_dur_to_worst_1w_percent_change="
				+ semi_mod_dur_to_worst_1w_percent_change
				+ ", effective_duration=" + effective_duration
				+ ", effective_duration_1w_percent_change="
				+ effective_duration_1w_percent_change
				+ ", mod_duration_to_worst=" + mod_duration_to_worst
				+ ", mod_duration_to_worst_1w_percent_change="
				+ mod_duration_to_worst_1w_percent_change
				+ ", modified_duration=" + modified_duration
				+ ", modified_duration_1w_percent_change="
				+ modified_duration_1w_percent_change + ", macaulay_duration="
				+ macaulay_duration + ", macaulay_duration_1w_percent_change="
				+ macaulay_duration_1w_percent_change
				+ ", effective_convexity=" + effective_convexity
				+ ", effective_convexity_1w_percent_change="
				+ effective_convexity_1w_percent_change
				+ ", semi_convexity_to_worst=" + semi_convexity_to_worst
				+ ", semi_convexity_to_worst_1w_percent_change="
				+ semi_convexity_to_worst_1w_percent_change
				+ ", semi_convexity=" + semi_convexity
				+ ", semi_convexity_1w_percent_change="
				+ semi_convexity_1w_percent_change
				+ ", convexity_1w_percent_change="
				+ convexity_1w_percent_change + ", convexity=" + convexity
				+ ", subordination_type=" + subordination_type
				+ ", spread_duration=" + spread_duration
				+ ", spread_duration_1w_percent_change="
				+ spread_duration_1w_percent_change + ", maturity_type="
				+ maturity_type + ", asset_swap_spread=" + asset_swap_spread
				+ ", asset_swap_spread_1w_percent_change="
				+ asset_swap_spread_1w_percent_change + ", oas=" + oas
				+ ", oas_1w_percent_change=" + oas_1w_percent_change
				+ ", effective_yield=" + effective_yield
				+ ", effective_yield_1w_percent_change="
				+ effective_yield_1w_percent_change + ", semi_yield_to_worst="
				+ semi_yield_to_worst
				+ ", semi_yield_to_worst_1w_percent_change="
				+ semi_yield_to_worst_1w_percent_change
				+ ", yield_to_worst_conv=" + yield_to_worst_conv
				+ ", yield_to_worst_conv_1w_percent_change="
				+ yield_to_worst_conv_1w_percent_change
				+ ", yield_to_maturity=" + yield_to_maturity
				+ ", yield_to_maturity_1w_percent_change="
				+ yield_to_maturity_1w_percent_change + ", semi_mod_dur="
				+ semi_mod_dur + ", semi_mod_dur_1w_percent_change="
				+ semi_mod_dur_1w_percent_change + ", yield_to_next_call="
				+ yield_to_next_call
				+ ", yield_to_next_call_1w_percent_change="
				+ yield_to_next_call_1w_percent_change + ", price=" + price
				+ ", accrued_interest=" + accrued_interest
				+ ", spread_to_worst=" + spread_to_worst
				+ ", spread_to_worst_1w_percent_change="
				+ spread_to_worst_1w_percent_change + ", libor_oas="
				+ libor_oas + ", libor_oas_1w_percent_change="
				+ libor_oas_1w_percent_change + ", index_name=" + index_name
				+ ", bond_equiv=" + bond_equiv + "]";
	}
