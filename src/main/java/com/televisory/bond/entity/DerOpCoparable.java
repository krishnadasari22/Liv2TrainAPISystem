...
public class DerOpCoparable {

	@Id
	@Column(name = "call_symbol")
	private String call_symbol;

	@Column(name = "call_expiry_date")
	private Date call_expiry_date;

	@Column(name = "call_latest_settlement")
	private Double call_latest_settlement;
	
	@Column(name = "call_last_trade")
	private Double call_last_trade;

	@Column(name = "call_total_volume")
	private Double call_total_volume;

	@Column(name = "call_open_interest")
	private Double call_open_interest;

	@Column(name = "strike")
	private Double strike;

	@Column(name = "put_latest_settlement")
	private Double put_latest_settlement;
	
	@Column(name = "put_last_trade")
	private Double put_last_trade;

	@Column(name = "put_total_volume")
	private Double put_total_volume;

	@Column(name = "put_open_interest")
	private Double put_open_interest;

	@Column(name = "put_expiry_date")
	private Date put_expiry_date;

	@Column(name = "put_symbol")
	...
	public String toString() {
		return "DerOpCoparable [call_symbol=" + call_symbol + ", call_expiry_date=" + call_expiry_date
				+ ", call_latest_settlement=" + call_latest_settlement + ", call_last_trade=" + call_last_trade
				+ ", call_total_volume=" + call_total_volume + ", call_open_interest=" + call_open_interest
				+ ", strike=" + strike + ", put_latest_settlement=" + put_latest_settlement + ", put_last_trade="
				+ put_last_trade + ", put_total_volume=" + put_total_volume + ", put_open_interest=" + put_open_interest
				+ ", put_expiry_date=" + put_expiry_date + ", put_symbol=" + put_symbol + "]";
	}
