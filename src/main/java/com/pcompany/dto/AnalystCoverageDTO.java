...
public class AnalystCoverageDTO implements Serializable{
	...
	public String toString() {
		return "AnalystCoverageDTO [id=" + id + ", companyId=" + companyId + ", feItem=" + feItem + ", buy=" + buy
				...
				+ ", netmovement=" + netmovement + ", currency=" + currency + ", unit=" + unit + "]";
	}
